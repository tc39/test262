...
assert.sameValue(encodeURI(object), "%5Bobject%20Object%5D", '#1: var object = {valueOf: function() {return "^"}}; encodeURI(object) === %5Bobject%20Object%5D');
...
assert.sameValue(encodeURI(object), "%5E", '#2: var object = {valueOf: function() {return ""}, toString: function() {return "^"}}; encodeURI(object) === "%5E"');
...
assert.sameValue(encodeURI(object), "%5E", '#3: var object = {valueOf: function() {return "^"}, toString: function() {return {}}}; encodeURI(object) === "%5E"');
...
assert.sameValue(encodeURI(object), "%5E", '#5: var object = {toString: function() {return "^"}}; encodeURI(object) === "%5E"');
...
assert.sameValue(encodeURI(object), "%5E", '#6: var object = {valueOf: function() {return {}}, toString: function() {return "^"}}; encodeURI(object) === "%5E"');
