...
description: >
  String.prototype.trim - 'S' is a string starting and ending with U+180E
info: >
...
var str = mongolianVowelSeparator + "abc" + mongolianVowelSeparator;

assert.sameValue(str.trim(), "\u180Eabc\u180E", "Leading and trailing U+180E");
