...
/*---
description: Float32Array Constructor (TypedArray's [[ByteOffset]] internal slot is always a positive number, test with negative zero.)
esid: pending
...
var typedArray = new Float32Array(new SharedArrayBuffer(8), -0);
