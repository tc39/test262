...
// - src/TypedArrays/ctors/buffer-arg-defined-length.template
/*---
description: Uint8ClampedArray Constructor (Return new typedArray from defined length)
...
var len = 4;
var buffer = new ArrayBuffer(bpe * len * 4);
