...
function SortWithCustomComparison() {
  for (let ctor of ctors) {
    ...
    WriteUnsortedData();
    TypedArraySortHelper(fixedLength, CustomComparison);
    ...
    WriteUnsortedData();
    TypedArraySortHelper(fixedLengthWithOffset, CustomComparison);
    assert.compareArray(ToNumbers(taFull), [
      10,
      9,
      7,
    ...
    WriteUnsortedData();
    TypedArraySortHelper(lengthTracking, CustomComparison);
    assert.compareArray(ToNumbers(taFull), [
      7,
      9,
      8,
    ...
    WriteUnsortedData();
    TypedArraySortHelper(lengthTrackingWithOffset, CustomComparison);
    assert.compareArray(ToNumbers(taFull), [
      10,
      9,
      7,
