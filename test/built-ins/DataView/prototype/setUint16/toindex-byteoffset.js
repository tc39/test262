...
assert.sameValue(sample.getUint16(1), 42, "object's valueOf");

sample.setUint16(0, 0);
sample.setUint16(obj2, 42);
assert.sameValue(sample.getUint16(1), 42, "object's toString");
...
sample.setUint16(0, 0);
sample.setUint16("1", 42);
assert.sameValue(sample.getUint16(1), 42, "string '1'");
