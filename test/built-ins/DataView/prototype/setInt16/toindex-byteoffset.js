...
assert.sameValue(sample.getInt16(1), 42, "object's valueOf");

sample.setInt16(0, 0);
sample.setInt16(obj2, 42);
assert.sameValue(sample.getInt16(1), 42, "object's toString");
...
sample.setInt16(0, 0);
sample.setInt16("1", 42);
assert.sameValue(sample.getInt16(1), 42, "string '1'");
