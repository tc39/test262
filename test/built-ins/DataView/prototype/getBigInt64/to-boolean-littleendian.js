...
assert.sameValue(sample.getBigInt64(0, Infinity), -0x100000000000000n, "ToBoolean: Number != 0 => true");
...
assert.sameValue(sample.getBigInt64(0, "string"), -0x100000000000000n, "ToBoolean: String .length > 0 => true");
assert.sameValue(sample.getBigInt64(0, "false"), -0x100000000000000n, "ToBoolean: String .length > 0 => true");
assert.sameValue(sample.getBigInt64(0, " "), -0x100000000000000n, "ToBoolean: String .length > 0 => true");
assert.sameValue(sample.getBigInt64(0, Symbol("1")), -0x100000000000000n, "ToBoolean: Symbol => true");
...
assert.sameValue(sample.getBigInt64(0, {}), -0x100000000000000n, "ToBoolean: any object => true");
assert.sameValue(sample.getBigInt64(0, Object(false)), -0x100000000000000n, "ToBoolean: any object => true; no ToPrimitive");
