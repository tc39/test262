...
assert.sameValue(sample.getBigInt64(undefined), 0x2702060280008001n, "ToIndex: undefined => NaN => 0");
...
assert.sameValue(sample.getBigInt64("foo"), 0x2702060280008001n, "ToIndex: parse Number => NaN => 0");
assert.sameValue(sample.getBigInt64("true"), 0x2702060280008001n, "ToIndex: parse Number => NaN => 0");
...
assert.sameValue(sample.getBigInt64("2.9"), 0x602800080017F00n, "toIndex: parse Number => truncate towards 0");
...
assert.sameValue(sample.getBigInt64("3.9"), 0x2800080017F0001n, "toIndex: parse Number => truncate towards 0");
assert.sameValue(sample.getBigInt64([0]), 0x2702060280008001n, 'ToIndex: [0].toString() => "0" => 0');
assert.sameValue(sample.getBigInt64(["1"]), 0x20602800080017fn, 'ToIndex: ["1"].toString() => "1" => 1');
assert.sameValue(sample.getBigInt64({}), 0x2702060280008001n, 'ToIndex: ({}).toString() => "[object Object]" => NaN => 0');
assert.sameValue(sample.getBigInt64([]), 0x2702060280008001n, 'ToIndex: [].toString() => "" => NaN => 0');
