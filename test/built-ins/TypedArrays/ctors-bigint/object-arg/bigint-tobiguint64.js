...
var typedArray = new BitUint64Array(vals);

assert.sameValue(typedArray[0], 2n,
                 "Wrapping of postive value greater than 2^64");

assert.sameValue(typedArray[1], Math.pow(2n, 64n) + 2n,
...
assert.sameValue(typedArray[4], Math.pow(2n, 64n) - 2n,
...
assert.sameValue(typedArray[6], Math.pow(2n, 64n) - 2n,
