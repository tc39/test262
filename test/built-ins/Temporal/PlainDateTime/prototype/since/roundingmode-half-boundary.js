...
info: |
  ...
  datetimes 2019-01-01T00:00 and 2020-07-02T00:00 produces a difference of
  -1 year minus 183 days. The intermediate year (2020) is a leap year with
  366 days, so the fractional progress is exactly 183/366 = 0.5. This exercises
  the tie-breaking behavior of all half-* rounding modes in
  RoundRelativeDuration in the negative direction, where halfExpand and
  halfCeil diverge (away from zero vs toward positive infinity).

  With 2018-01-01T00:00 and 2020-07-02T00:00 the difference is -2 years minus
  183 days, giving the same 0.5 fractional progress but with an even integer
  part. This distinguishes halfEven from halfExpand in the negative direction.
