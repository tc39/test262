...
description: Temporal.Instant.prototype.add() throws RangeError while the result is too big or too small.
info: |
...
assert.throws(RangeError, () => i1.add(new Temporal.Duration(0, 0, 0, 0, 999999999)),
    "add show throw from AddInstant while the result is out of range");
