...
info: |
  ...
  progress is exactly 183/366 = 0.5. This allows distinguishing all half-*
  rounding modes in the negative direction, where halfExpand and halfCeil
  diverge (away from zero vs toward positive infinity).
