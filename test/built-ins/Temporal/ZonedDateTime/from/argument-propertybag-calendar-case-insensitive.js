...
assert.sameValue(result1.calendarId, "iso8601", "Calendar is case-insensitive");

arg = { year: 1970, monthCode: "M01", day: 1, timeZone, calendar: { calendar } };
const result2 = Temporal.ZonedDateTime.from(arg);
assert.sameValue(result2.calendarId, "iso8601", "Calendar is case-insensitive (nested property)");
