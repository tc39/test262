...
assert.sameValue(arr.length, 0, '#2: var x = [0,1,2,3,4]; var arr = x.slice(5,5); arr.length === 0');

assert.sameValue(arr[0], undefined, '#3: var x = [0,1,2,3,4]; var arr = x.slice(5,5); arr[0] === undefined');
