...
description: >
    If _start_ or _end_ is a BigInt, Array.prototype.slice throws TypeError.
info: |
...
assert.throws(TypeError, function () {
    [0].slice(0n, 0);
}, "If _start_ is a BigInt, Array.prototype.slice throws TypeError.")

//Check #2
assert.throws(TypeError, function () {
    [0].slice(0, 0n);
}, "If _end_ is a BigInt, Array.prototype.slice throws TypeError.")
