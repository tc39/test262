...
description: >
    If _start_ or _deleteCount_ is a Symbol, Array.prototype.splice throws TypeError.
info: |
...
assert.throws(TypeError, function () {
    [].splice(Symbol(), 0, 0);
}, "If _start_ is a Symbol, Array.prototype.splice throws TypeError.");

//Check #2
assert.throws(TypeError, function () {
    [].splice(0, Symbol(), 0);
}, "If _deleteCount_ is a Symbol, Array.prototype.splice throws TypeError.");
