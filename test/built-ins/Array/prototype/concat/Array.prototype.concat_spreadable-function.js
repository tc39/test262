...
assert(compareArray([fn], [].concat(fn)), 'compareArray([fn], [].concat(fn)) must return true');

// Functions may be individually concat-spreadable
fn[Symbol.isConcatSpreadable] = true;
fn[0] = 1, fn[1] = 2, fn[2] = 3;
assert(compareArray([1, 2, 3], [].concat(fn)), 'compareArray([1, 2, 3], [].concat(fn)) must return true');

Function.prototype[Symbol.isConcatSpreadable] = true;
// Functions may be concat-spreadable
assert(
  compareArray([void 0, void 0, void 0], [].concat(function(a, b, c) {})),
  'compareArray([void 0, void 0, void 0], [].concat(function(a, b, c) {})) must return true'
);
Function.prototype[0] = 1;
Function.prototype[1] = 2;
Function.prototype[2] = 3;
assert(
  compareArray([1, 2, 3], [].concat(function(a, b, c) {})),
  'compareArray([1, 2, 3], [].concat(function(a, b, c) {})) must return true'
);
