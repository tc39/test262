...
assert(compareArray([bool], [].concat(bool)), 'compareArray([bool], [].concat(bool)) must return true');
...
assert(
  compareArray([1, 2, 3], [].concat(bool)),
  'compareArray([1, 2, 3], [].concat(bool)) must return true'
);

Boolean.prototype[Symbol.isConcatSpreadable] = true;
// Boolean wrapper objects may be concat-spreadable
assert(
  compareArray([], [].concat(new Boolean(true))),
  'compareArray([], [].concat(new Boolean(true))) must return true'
);
...
assert(
  compareArray([1, 2, 3], [].concat(new Boolean(true))),
  'compareArray([1, 2, 3], [].concat(new Boolean(true))) must return true'
);
