...
description: >
    If _start_ or _skipCount_ is a BigInt, Array.prototype.toSpliced throws TypeError.
info: |
...
assert.throws(TypeError, function () {
    [].toSpliced(0n, 0, 0);
}, "If _start_ is a BigInt, Array.prototype.toSpliced throws TypeError.");

//Check #2
assert.throws(TypeError, function () {
    [].toSpliced(0, 0n, 0);
}, "If _skipCount_ is a BigInt, Array.prototype.toSpliced throws TypeError.");
