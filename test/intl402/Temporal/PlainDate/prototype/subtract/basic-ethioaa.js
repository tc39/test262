...
TemporalHelpers.assertPlainDate(
  ...
  2019, 2, "M02", 1, "Adding 1 year to day 1 of a month", "aa", 2019
);

TemporalHelpers.assertPlainDate(
  date202302.subtract(years1),
  2024, 2, "M02", 29, "Adding 1 year to day 29 of a month", "aa", 2024
);

TemporalHelpers.assertPlainDate(
  date201802.subtract(years5),
  2023, 2, "M02", 1, "Adding 5 years to day 1 of a month", "aa", 2023
);

TemporalHelpers.assertPlainDate(
  date202302.subtract(years5),
  2028, 2, "M02", 29, "Adding 5 years to day 29 of a month", "aa", 2028
);

TemporalHelpers.assertPlainDate(
  date201802.subtract(years1n),
  2017, 2, "M02", 1, "Subtracting 1 year from day 1 of a month", "aa", 2017
);

TemporalHelpers.assertPlainDate(
  date202302.subtract(years1n),
  2022, 2, "M02", 29, "Subtracting 1 year from day 29 of a month", "aa", 2022
);

TemporalHelpers.assertPlainDate(
  date201802.subtract(years5n),
  2013, 2, "M02", 1, "Subtracting 5 years from day 1 of a month", "aa", 2013
);

TemporalHelpers.assertPlainDate(
  date202302.subtract(years5n),
  2018, 2, "M02", 29, "Subtracting 5 years from day 29 of a month", "aa", 2018
);
...
TemporalHelpers.assertPlainDate(
  ...
  2019, 12, "M12", 1, "Adding 1 month, with result in same year", "aa", 2019
);

TemporalHelpers.assertPlainDate(
  date201813.subtract(months1),
  2019, 1, "M01", 1, "Adding 1 month, with result in next year", "aa", 2019
);

TemporalHelpers.assertPlainDate(
  date201906.subtract(months4),
  2019, 10, "M10", 1, "Adding 4 months, with result in same year", "aa", 2019
);

TemporalHelpers.assertPlainDate(
  date201813.subtract(months4),
  2019, 4, "M04", 1, "Adding 4 months, with result in next year", "aa", 2019
);

TemporalHelpers.assertPlainDate(
  date201911.subtract(months1n),
  2019, 10, "M10", 1, "Subtracting 1 month, with result in same year", "aa", 2019
);

TemporalHelpers.assertPlainDate(
  date201901.subtract(months1n),
  2018, 13, "M13", 1, "Subtracting 1 month, with result in previous year", "aa", 2018
);

TemporalHelpers.assertPlainDate(
  date201906.subtract(months4n),
  2019, 2, "M02", 1, "Subtracting 4 months, with result in same year", "aa", 2019
);

TemporalHelpers.assertPlainDate(
  date201901.subtract(months4n),
  2018, 10, "M10", 1, "Subtracting 4 months, with result in previous year", "aa", 2018
);
...
TemporalHelpers.assertPlainDate(
  ...
  2021, 3, "M03", 22, "add 2 months 3 weeks from non-leap day/month, ending in same year", "aa", 2021
);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2021, monthCode: "M12", day: 29, calendar }, options).subtract(months2weeks3),
  2022, 2, "M02", 20, "add 2 months 3 weeks from end of year to next year", "aa", 2022
);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2021, monthCode: "M06", day: 1, calendar }, options).subtract(months2weeks3n),
  2021, 3, "M03", 10, "subtract 2 months 3 weeks from non-leap day/month, ending in same year", "aa", 2021
);

TemporalHelpers.assertPlainDate(
  date202101.subtract(months2weeks3n),
  2020, 11, "M11", 10, "subtract 2 months 3 weeks from beginning of year to previous year", "aa", 2020
);
...
TemporalHelpers.assertPlainDate(
  ...
  2021, 1, "M01", 11, "add 10 days, ending in same month", "aa", 2021
);

TemporalHelpers.assertPlainDate(
  date20210129.subtract(days10),
  2021, 2, "M02", 10, "add 10 days, ending in following month", "aa", 2021
);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 2021, monthCode: "M13", day: 5, calendar }, options).subtract(days10),
  2022, 1, "M01", 10, "add 10 days, ending in following year", "aa", 2022
);

TemporalHelpers.assertPlainDate(
  date20210129.subtract(days10n),
  2021, 1, "M01", 20, "subtract 10 days, ending in same month", "aa", 2021
);

TemporalHelpers.assertPlainDate(
  date201906.subtract(days10n),
  2019, 5, "M05", 21, "subtract 10 days, ending in previous month", "aa", 2019
);

TemporalHelpers.assertPlainDate(
  date202101.subtract(days10n),
  2020, 12, "M12", 26, "subtract 10 days, ending in previous year", "aa", 2020
);
