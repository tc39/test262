...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 7206, monthCode: "M12", day: 29, calendar }, options).add(months2weeks3),
  7207, 2, "M02", 20, "add 2 months 3 weeks from end of year to next year", "aa", 7207
);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 7206, monthCode: "M06", day: 1, calendar }, options).add(months2weeks3n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 7206, monthCode: "M13", day: 5, calendar }, options).add(days10),
