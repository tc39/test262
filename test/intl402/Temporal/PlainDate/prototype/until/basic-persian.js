...
const date13401228 = Temporal.PlainDate.from({ year: 1340, monthCode: "M12", day: 28, calendar });
...
const date13621229 = Temporal.PlainDate.from({ year: 1362, monthCode: "M12", day: 29, calendar });
...
const date13631228 = Temporal.PlainDate.from({ year: 1363, monthCode: "M12", day: 28, calendar });
...
const date13640614 = Temporal.PlainDate.from({ year: 1364, monthCode: "M06", day: 14, calendar });
...
const date13640815 = Temporal.PlainDate.from({ year: 1364, monthCode: "M08", day: 15, calendar });
