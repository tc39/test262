...
const date13401228 = Temporal.PlainDateTime.from({ year: 1340, monthCode: "M12", day: 28, hour: 12, minute: 34, calendar });
...
const date13621229 = Temporal.PlainDateTime.from({ year: 1362, monthCode: "M12", day: 29, hour: 12, minute: 34, calendar });
...
const date13631228 = Temporal.PlainDateTime.from({ year: 1363, monthCode: "M12", day: 28, hour: 12, minute: 34, calendar });
...
const date13640614 = Temporal.PlainDateTime.from({ year: 1364, monthCode: "M06", day: 14, hour: 12, minute: 34, calendar });
...
const date13640815 = Temporal.PlainDateTime.from({ year: 1364, monthCode: "M08", day: 15, hour: 12, minute: 34, calendar });
