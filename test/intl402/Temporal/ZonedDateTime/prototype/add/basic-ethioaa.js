...
TemporalHelpers.assertPlainDateTime(
  date720601.add(months2weeks3).toPlainDateTime(),
  7206, 3, "M03", 22, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from non-leap day/month, ending in same year", "aa", 7206
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 7206, monthCode: "M12", day: 29, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(months2weeks3).toPlainDateTime(),
  7207, 2, "M02", 20, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from end of year to next year", "aa", 7207
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 7206, monthCode: "M06", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(months2weeks3n).toPlainDateTime(),
  7206, 3, "M03", 10, 12, 34, 0, 0, 0, 0, "subtract 2 months 3 weeks from non-leap day/month, ending in same year", "aa", 7206
);

TemporalHelpers.assertPlainDateTime(
  date720601.add(months2weeks3n).toPlainDateTime(),
