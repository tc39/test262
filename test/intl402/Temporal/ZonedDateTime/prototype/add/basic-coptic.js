...
TemporalHelpers.assertPlainDateTime(
  date174501.add(months2weeks3).toPlainDateTime(),
  1745, 3, "M03", 22, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from non-leap day/month, ending in same year", "am", 1745
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1745, monthCode: "M12", day: 29, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(months2weeks3).toPlainDateTime(),
  1746, 2, "M02", 20, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from end of year to next year", "am", 1746
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1745, monthCode: "M06", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(months2weeks3n).toPlainDateTime(),
  1745, 3, "M03", 10, 12, 34, 0, 0, 0, 0, "subtract 2 months 3 weeks from non-leap day/month, ending in same year", "am", 1745
);

TemporalHelpers.assertPlainDateTime(
  date174501.add(months2weeks3n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date174501.add(days10).toPlainDateTime(),
  1745, 1, "M01", 11, 12, 34, 0, 0, 0, 0, "add 10 days, ending in same month", "am", 1745
);

TemporalHelpers.assertPlainDateTime(
  date17450129.add(days10).toPlainDateTime(),
  1745, 2, "M02", 10, 12, 34, 0, 0, 0, 0, "add 10 days, ending in following month", "am", 1745
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1745, monthCode: "M13", day: 5, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(days10).toPlainDateTime(),
  1746, 1, "M01", 10, 12, 34, 0, 0, 0, 0, "add 10 days, ending in following year", "am", 1746
);

TemporalHelpers.assertPlainDateTime(
  date17450129.add(days10n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date174501.add(days10n).toPlainDateTime(),
