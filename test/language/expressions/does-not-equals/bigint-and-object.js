...
assert.sameValue(0n != Object(0n), false);
assert.sameValue(Object(0n) != 0n, false);
...
assert.sameValue(1n != Object(1n), false);
assert.sameValue(Object(1n) != 1n, false);
...
assert.sameValue(2n != Object(2n), false);
assert.sameValue(Object(2n) != 2n, false);
