...
x = true;
x |= new Number(1);
assert.sameValue(x, 1, '#5: x = true; x |= new Number(1); x === 1');

//CHECK#6
x = new Number(1);
x |= true;
assert.sameValue(x, 1, '#6: x = new Number(1); x |= true; x === 1');

//CHECK#7
x = new Boolean(true);
x |= new Number(1);
assert.sameValue(x, 1, '#7: x = new Boolean(true); x |= new Number(1); x === 1');

//CHECK#8
x = new Number(1);
x |= new Boolean(true);
assert.sameValue(x, 1, '#8: x = new Number(1); x |= new Boolean(true); x === 1');
