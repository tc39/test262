...
x = true;
x %= new String("1");
assert.sameValue(x, 0, '#5: x = true; x %= new String("1"); x === 0');

//CHECK#6
x = new String("1");
x %= true;
assert.sameValue(x, 0, '#6: x = new String("1"); x %= true; x === 0');

//CHECK#7
x = new Boolean(true);
x %= new String("1");
assert.sameValue(x, 0, '#7: x = new Boolean(true); x %= new String("1"); x === 0');

//CHECK#8
x = new String("1");
x %= new Boolean(true);
assert.sameValue(x, 0, '#8: x = new String("1"); x %= new Boolean(true); x === 0');
