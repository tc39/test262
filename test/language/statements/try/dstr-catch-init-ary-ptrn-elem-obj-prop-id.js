...
/*---
description: BindingElement with object binding pattern and initializer is not used (try catch with initializer statement)
...
try {
  throw undefined;
} catch ([{ u: v, w: x, y: z } = { u: 444, w: 555, y: 666 }] = [{ u: 777, w: 888, y: 999 }]) {
