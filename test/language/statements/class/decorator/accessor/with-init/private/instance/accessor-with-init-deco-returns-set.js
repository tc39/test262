...
/*---
description: Accessor decorator can return a new setter when initializer is present (private accessor with initializer decorator behavior in class declaration)
