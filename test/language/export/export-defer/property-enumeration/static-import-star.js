...
description: >
  Reflect.ownKeys lists deferred-reexport names for static `import * as ns`
info: |
  [[OwnPropertyKeys]] ( )
...
assert.compareArray(globalThis.evaluations, ["barrel"],
  "barrel evaluated eagerly; deferred dep not yet evaluated");
...
assert.compareArray(globalThis.evaluations, ["barrel"],
  "Reflect.ownKeys does not trigger evaluation of the deferred dep");
