...
There are two systems for generating tests. To generate or regenerate all files:
...
For information on direct command line access to this test generation mechanism:

    ./tools/generation/generate_type_coercion.py --help
